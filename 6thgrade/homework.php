...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; תרגילי בית</li>
    	<li><a href="fracture1.php">&nbsp;שברים פשוטים</a></li>
        <li><a href="fracture2.php">&nbsp;שברים עשרוניים</a></li>
	    <li><a href="precent.php">&nbsp;אחוזים</a></li>
		<li><a href="geo.php">&nbsp;גאומטריה</a></li>
        <li><a href="sdarot.php">&nbsp;סדרות</a></li>
    	<li><a href="equal.php">&nbsp;השוואות</a></li>
	    <li><a href="verbal.php">&nbsp;בעיות מילוליות</a></li>
		<li><a href="gimatria.php">&nbsp;גימטריה</a></li>
