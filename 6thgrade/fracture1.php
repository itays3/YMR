...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; שברים פשוטים</li>
    	<li><a href="functions/mainfracture_a.php" target="Mainframe">&nbsp;שברים פשוטים - חיבור</a></li>
        <li><a href="functions/mainfracture_b.php" target="Mainframe">&nbsp;שברים פשוטים - חיסור</a></li>
        <li><a href="functions/mainfracture_c.php" target="Mainframe">&nbsp;שברים פשוטים - כפל</a></li>
        <li><a href="functions/mainfracture_d.php" target="Mainframe">&nbsp;שברים פשוטים - חילוק</a></li>
    </ul>
