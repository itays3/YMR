...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; שברים עשרוניים</li>
        <li><a href="functions/mainfracture_g.php" target="Mainframe">&nbsp;שברים עשרוניים - חיבור</a></li>
        <li><a href="functions/mainfracture_h.php" target="Mainframe">&nbsp;שברים עשרוניים - חיסור</a></li>
        <li><a href="functions/mainfracture_e.php" target="Mainframe">&nbsp;שברים עשרוניים - כפל</a></li>
        <li><a href="functions/mainfracture_f.php" target="Mainframe">&nbsp;שברים עשרוניים - חילוק</a></li>
