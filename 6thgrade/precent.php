...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; אחוזים</li>
    	<li><a href="functions/precent/precent_a1.php" target="Mainframe">&nbsp;שברים פשוטים לאחוזים</a></li>
        <li><a href="functions/precent/precent_b1.php" target="Mainframe">&nbsp;אחוזים לשברים פשוטים</a></li>
        <li><a href="functions/precent/precent_c1.php" target="Mainframe">&nbsp;שברים מעורבים לאחוזים</a></li>
        <li><a href="functions/precent/precent_d1.php" target="Mainframe">&nbsp;אחוזים לשברים מעורבים</a></li>
