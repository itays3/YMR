...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:24px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">סיכום השוואות שברים - רמה בינונית</h1>
	<p dir="rtl"
...
<form method="post" action="equal_c2.php">    
