...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:24px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">השוואת שברים פשוטים - רמה בינונית</h1>
	<p dir="rtl"
...
<form method="post" action="equal_a2.php">    
    <table cellpadding="3" cellspacing="3" align="center" >
    	<tr>
            ...
            <td rowspan="2" align="center">+</td>
            <td align="center" style="border-bottom: thin solid black;"><?php print $x4; ?></td>
    ...
    <!-- this part shows the last exercise and the answer-->
		<tr><td align="center"><?php print $y1; ?></td>
        	...
        	<td align="center"><?php print $y4; ?></td>
        </tr>
		...
		<tr> 
            ...
            <td align="center" rowspan="2">+</td>
            <td align="center" style="border-bottom: thin solid black;"><?php print $_POST['last_x4'];?></td>
        ...
        <tr><td align="center"><?php print $_POST['last_y1'];?></td>
        	...
        	<td align="center"><?php print $_POST['last_y4'];?></td>
