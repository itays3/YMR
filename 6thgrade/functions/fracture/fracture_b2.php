...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חיסור שברים</h1>
	<p dir="rtl"
	...
	<?php 
	 ...
	 do{
	  ...
	  $the_answer1 = round($x*$num1);
	  $the_answer2 = round($y*$num2);
...
<table align="center" dir="ltr">
    ...
    <!-- this part shows the last exercise and the answer-->
		...
		{
			if ($_POST['final']==$_POST['answer1'] && $_POST['last_mehane']==$_POST['answer2'])
