...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:32px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חילוק שברים עשרוניים במאונך</h1>
	<p dir="rtl"
...
?>
<form method="post" action="fracture_f3.php" dir="ltr">    
<table align="center" dir="ltr">
    
        	
		<tr>
        	<td align="center" style="border-bottom: thin solid black;"><?php print $num1; ?> </td>
    	...
    	<tr>
        <td align="center" style="border-bottom: thick solid black;" ><?php print $num2; ?> </td></tr>
