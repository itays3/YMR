...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חיסור שלם ושבר</h1>
	<p dir="rtl"
	...
	<?php 
	  ...
	  while ($the_answer1<0);
?>
<form method="post" action="fracture_b1.php" dir="ltr">    
