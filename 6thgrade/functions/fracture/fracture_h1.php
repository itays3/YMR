...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:32px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חיסור שבר עשרוני ושלם</h1>
	<p dir="rtl"
	...
	<?php 
	  ...
	  while ($num1<$num2)
?>
<form method="post" action="fracture_h1.php" dir="ltr">    
