...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חילוק שברים מעורבים</h1>
	<p dir="rtl"
	...
	<?php 
	  ...
	  $the_answer1 = $num1*$z1+$x;
	  $the_answer2 = $num2*$z2+$y;
	  
	  $final1 = $the_answer1*$z2;
	  $final2 = $the_answer2*$z1;
	  
?>
<form method="post" action="fracture_d4.php" dir="ltr">    
<table align="center" dir="ltr">   	
		...
		<tr>
        	<td align="center"><?php print $z1; ?></td>
        ...
        <input name="the_final1" type="hidden" value="<?=$final1?>"/>
    	<input name="the_final2" type="hidden" value="<?=$final2?>"/>
    ...
    <!-- this part shows the last exercise and the answer-->
        ...
        <tr>
		    ...
		    <td rowspan="2" align="center" valign="middle">=</td>
		    <td align="center" style="border-bottom: thin solid black;"><?php print $_POST['the_final1'];?></td>
		<td rowspan="3" valign="middle">    
		<?php	
		if (isset($_POST['answer1'])&&isset($_POST['answer2']) ) 
		{
			if ($_POST['the_final1']==$_POST['answer1'] && $_POST['the_final2']==$_POST['answer2'])
        ...
        <tr>   
           ...
           <td align="center"><?php print $_POST['the_final2'];?></td>
		<?php } ?>
		</tr></table>
</form>
