...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חילוק שבר בשלם</h1>
	<p dir="rtl"
...
?>
<form method="post" action="fracture_d2.php" dir="ltr">    
<table align="center" dir="ltr">
    ...
    <!-- this part shows the last exercise and the answer-->
            ...
            <?php if(!empty($_POST['last_x'])&&!empty($_POST['last_num1'])) {?>
		<table align="center">
        <tr>
