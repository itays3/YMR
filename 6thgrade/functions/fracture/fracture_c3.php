...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">כפל מספרים מעורבים</h1>
	<p dir="rtl"
	...
	<?php 
	  ...
	  $final1 = $the_answer1*$the_answer2;
	  $final2 = $z1*$z2;
	    
?>
<form method="post" action="fracture_c3.php" dir="ltr">    
