...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:30px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חילוק ארוך של שברים עשרוניים</h1>
	<p dir="rtl"
...
?>
<form method="post" action="fracture_f4.php" dir="ltr">    
<table align="center" dir="ltr">
    
        	
		<tr>
        	<td align="center" style="border-top: thin solid black;border-right: thin solid black;"><?php print $num1; ?> </td>
