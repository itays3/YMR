...
<?php 
		...
		$username = $_SESSION['username'];
            ...
            <tr><td><p>חיבור עד 100</p></td><td><P><? if ($total1!=0){ echo intval($counter_yes1/$total1 * 100), "%  הצלחה "; } 
            ...
            <tr><td><p>חיבור עד 200</p></td><td><P><? if ($total4!=0){ echo intval($counter_yes4/$total4 * 100), "%  הצלחה ";  }
			else echo "עדיין אין נתונים " ?></P></td>
            ...
            <tr><td><p>חיבור בעשרות עד 1000</p></td><td><P><? if ($total7!=0){ echo intval($counter_yes7/$total7 * 100), "%  הצלחה "; }
			else echo "עדיין אין נתונים " ?></P></td>
            ...
            <tr><td><p>חיבור בשרשרת עד 200</p></td><td><P><? if ($total10!=0){ echo intval($counter_yes10/$total10 * 100), "%  הצלחה "; }
			else echo "עדיין אין נתונים" ?></P></td> 
            ...
            <tr><td><p>חיבור בשרשרת עד 1000</p></td><td><P><? if ($total13!=0){ echo intval($counter_yes13/$total13 * 100), "%  הצלחה "; }
			else echo "עדיין אין נתונים " ?></P></td>
            ...
            <tr><td><p>חיבור במאונך</p></td><td><P><? if ($total16!=0){ echo intval($counter_yes16/$total16 * 100), "%  הצלחה"; }
			else echo "עדיין אין נתונים " ?></P></td> 
