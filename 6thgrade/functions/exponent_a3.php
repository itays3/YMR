...
<body>
    ...
    <h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חזקות</h1>
	<p dir="rtl"
    style="font-family:Cursive;font-size:24px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">כתוב במילים</p>
	<?php 
	  echo "<font size=5>";
	  $x = rand(1,10);
      $y = rand(1,10);
	   ...
	   $the_answer2 = $y;
?>
<form method="post" action="plus_a1.php" dir="ltr">    
    <table align="center" dir="ltr" >
    	<tr>
    		<td align="right" colspan="2"><?php print $x; ?></td>
            <td align="left" valign="top" colspan="2"><?php echo "<font size=2>" .$y; ?></td></tr>
		<tr>
...
VALUES
('%s','1','$_POST[last_x]$_POST[plus]$_POST[last_y]$_POST[equal]$_POST[answer]','plus_a1','%s','%s')", $row['id'],$grade,$grade_num);
...
'$_POST[last_x]$_POST[plus]$_POST[last_y]$_POST[equal]$_POST[answer]','plus_a1','%s','%s')", $row['id'],$grade,$grade_num);
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
...
$query = "SELECT s_id, SUM(yes_count) FROM statistics WHERE s_id='$s_id' && subject='plus_a1'  GROUP BY s_id"; 
...
$query=sprintf("UPDATE connect SET plus_a1='%s' WHERE s_id='%s' ;",
