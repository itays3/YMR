...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; השוואות</li>
    	<li><a href="functions/mainequal_a.php" target="Mainframe">&nbsp;שברים פשוטים</a></li>
    	<li><a href="functions/mainequal_b.php" target="Mainframe">&nbsp;שברים עשרוניים</a></li>
	    <li><a href="functions/mainequal_c.php" target="Mainframe">&nbsp;שברים - סיכום</a></li>
