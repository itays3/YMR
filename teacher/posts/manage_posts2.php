...
<table width="600" border="1" align="right">
  ...
  <tr>
    ...
    <td align="right"><a href="update_post.php?post_id=<?php echo $row_getPosts['post_id']; ?>"><?php echo $row_getPosts['updated']; ?></a><a href="delete_post.php?post_id=<?php echo $row_getPosts['post_id']; ?>"></a></td>
  </tr>
