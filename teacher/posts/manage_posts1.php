...
$query_getPosts = "SELECT post_id, title, updated FROM forums WHERE grade='א' ORDER BY updated DESC";
...
<p  align="right" style="font-family:Cursive;font-size:24px;color:#3300cc;font-style:italic;font-weight:normal;"><a href="add_post1.php"> הוספת הודעה חדשה</a></p>
<div id="tb">
<table width="600" border="1" align="right">
  ...
  <?php do { ?>
  <tr>
    <td align="center"><a href="delete_post1.php?post_id=<?php echo $row_getPosts['post_id']; ?>">מחק</a></td>
    <td align="center"><a href="update_post1.php?post_id=<?php echo $row_getPosts['post_id']; ?>" >ערוך</a></td>
