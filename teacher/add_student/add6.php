...
if (isset($_POST['name']) )
{
	...
	VALUES
	('$_POST[username]','$_POST[password]','$_POST[name]','$school','f','ו','$_POST[grade]')");
...
<form id='register' action='add6.php' method='post'>
<fieldset >
<legend>רישום תלמיד לכיתה ו</legend>
...
if (isset($_POST['name'])){
echo "<font size=5>";
echo $_POST['name'], " ", "הצטרף לכיתה ו"," ", $_POST['grade'];
echo "</font>";
}
?>
</form>
