...
if (isset($_POST['name']) )
{
	...
	VALUES
	('$_POST[username]','$_POST[password]','$_POST[name]','$school','c','ג','$_POST[grade]')");
...
<form id='register' action='add3.php' method='post'>
<fieldset >
<legend>רישום תלמיד לכיתה ג</legend>
...
if (isset($_POST['name'])){
echo "<font size=5>";
echo $_POST['name'], " ", "הצטרף לכיתה ג"," ", $_POST['grade'];
echo "</font>";
}
?>
</form>
