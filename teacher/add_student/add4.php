...
if (isset($_POST['name']) )
{
	...
	VALUES
	('$_POST[username]','$_POST[password]','$_POST[name]','$school','d','ד','$_POST[grade]')");
...
<form id='register' action='add4.php' method='post'>
<fieldset >
<legend>רישום תלמיד לכיתה ד</legend>
...
if (isset($_POST['name'])){
echo "<font size=5>";
echo $_POST['name'], " ", "הצטרף לכיתה ד"," ", $_POST['grade'];
echo "</font>";
}
?>
</form>
