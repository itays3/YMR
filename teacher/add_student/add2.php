...
if (isset($_POST['name']) )
{
	...
	VALUES
	('$_POST[username]','$_POST[password]','$_POST[name]','$school','b','ב','$_POST[grade]')");
...
<form id='register' action='add2.php' method='post'>
<fieldset >
<legend>רישום תלמיד לכיתה ב</legend>
...
if (isset($_POST['name'])){
echo "<font size=5>";
echo $_POST['name'], " ", "הצטרף לכיתה ב"," ", $_POST['grade'];
echo "</font>";
}
?>
</form>
