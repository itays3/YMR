...
<div class='container'>
<form id='check' action='check6.php' method='post'>
...
$que = "SELECT * FROM homework WHERE grade_num='$level' && grade='f'";
...
<?php $j=1;  
$query = "SELECT * FROM connect WHERE grade_num='$level' && grade='ו' ORDER BY s_id"; 
