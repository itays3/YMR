...
<div class='container'>
<form id='check' action='check3.php' method='post'>
...
$que = "SELECT * FROM homework WHERE grade_num='$level' && grade='c'";
...
<?php $j=1;  
$query = "SELECT * FROM connect WHERE grade_num='$level' && grade='ג' ORDER BY s_id"; 
