...
<div class='container'>
<form id='check' action='check4.php' method='post'>
...
$que = "SELECT * FROM homework WHERE grade_num='$level' && grade='d'";
...
<?php $j=1;  
$query = "SELECT * FROM connect WHERE grade_num='$level' && grade='ד' ORDER BY s_id"; 
