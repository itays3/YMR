...
<div class="sidebar1">
    ...
    <table><tr><td align="center"><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; בדיקת שיעורי בית</li>
    	<li><a href="home_check/check1.php" target="Mainframe">&nbsp;כיתה א</a></li>
        <li><a href="home_check/check2.php" target="Mainframe">&nbsp;כיתה ב</a></li>
        <li><a href="home_check/check3.php" target="Mainframe">&nbsp;כיתה ג</a></li>
	    <li><a href="home_check/check4.php" target="Mainframe">&nbsp;כיתה ד</a></li>
	    <li><a href="home_check/check5.php" target="Mainframe">&nbsp;כיתה ה</a></li>
		<li><a href="home_check/check6.php" target="Mainframe">&nbsp;כיתה ו</a></li>
