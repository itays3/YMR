...
$query_getPosts = "SELECT id, username, password ,name, grade_letter, grade_num, date FROM students WHERE grade_letter='ו' && grade_num='$select'";
...
<p  align="right" style="font-family:Cursive;font-size:24px;color:#3300cc;font-style:italic;font-weight:normal;"><a href="../add_student/add6.php">הוספת תלמיד חדש</a></p>
<form id='check' action='update6.php' method='post' dir="rtl">
