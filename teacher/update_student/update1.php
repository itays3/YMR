...
$query_getPosts = "SELECT id, username, password ,name, grade_letter, grade_num, date FROM students WHERE grade_letter='א' && grade_num='$select'";
...
<p  align="right" style="font-family:Cursive;font-size:24px;color:#3300cc;font-style:italic;font-weight:normal;"><a href="../add_student/add1.php">הוספת תלמיד חדש</a></p>
<form id='check' action='update1.php' method='post' dir="rtl">
