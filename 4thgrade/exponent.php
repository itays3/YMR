...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; חזקות</li>
    	<li><a href="functions/exponent_a3.php" target="Mainframe">&nbsp;חזקות במילים</a></li>
    	<li><a href="functions/exponent_a2.php" target="Mainframe">&nbsp;חזקות בכפל</a></li>
	    <li><a href="functions/exponent_a1.php" target="Mainframe">&nbsp;תרגילים בחזקות</a></li>
