...
<h1 dir="rtl" 
	...
	<?php 
	  ...
	  $the_answer2 = $z;
?>
<form method="post" action="fracture_a3.php" dir="ltr">    
<table align="center" dir="ltr">
		...
		<tr><td align="center"><input name="answer2" type="text" size="1"/></td>
    ...
    <!-- this part shows the last exercise and the answer-->
		...
		{
			if ($_POST['last_x']==$_POST['answer1'] && $_POST['the_answer2']==$_POST['answer2'])
