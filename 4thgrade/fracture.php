...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; חיבור</li>
    	<li><a href="functions/mainfracture_a.php" target="Mainframe">&nbsp;חיבור עם מכנה משותף</a></li>
    	<li><a href="functions/mainfracture_b.php" target="Mainframe">&nbsp;חיבור ללא מכנה משותף</a></li>
		<li><a href="functions/mainfracture_c.php" target="Mainframe">&nbsp;חיסור עם מכנה משותף</a></li>
    	<li><a href="functions/mainfracture_d.php" target="Mainframe">&nbsp;חיסור ללא מכנה משוף</a></li>
    </ul>
