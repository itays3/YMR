...
<?php 
		...
		$username = $_SESSION['username'];
			...
			while($row = mysql_fetch_array($result))
			{
				if ($row['yes_count'] == 1 && $row['subject'] == plus10)
				{
					$counter_yes1 = $counter_yes1+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == plus10)
				{
					$counter_no1 = $counter_no1+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == plus20)
				{
					$counter_yes2 = $counter_yes2+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == plus20)
				{
					$counter_no2 = $counter_no2+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == plus100)
				{
					$counter_yes3 = $counter_yes3+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == plus100)
				{
					$counter_no3 = $counter_no3+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == plussh20)
				{
					$counter_yes4 = $counter_yes4+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == plussh20)
				{
					$counter_no4 = $counter_no4+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == plussh100)
				{
					$counter_yes5 = $counter_yes5+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == plussh100)
				{
