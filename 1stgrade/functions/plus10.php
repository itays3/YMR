...
VALUES
('%s','1','$_POST[last_a]$_POST[plus]$_POST[last_b]$_POST[equal]$_POST[answer]','plus10','%s','%s')", $row['id'],$grade,$grade_num);
...
'$_POST[last_a]$_POST[plus]$_POST[last_b]$_POST[equal]$_POST[answer]','plus10','%s','%s')", $row['id'],$grade,$grade_num);
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
