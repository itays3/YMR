...
VALUES
('%s','1','$_POST[last_x]$_POST[minus]$_POST[last_y]$_POST[minus]$_POST[last_z]$_POST[equal]$_POST[answer]','minussh200','%s','%s')", $row['id'],$grade,$grade_num);
...
'$_POST[last_x]$_POST[minus]$_POST[last_y]$_POST[minus]$_POST[last_z]$_POST[equal]$_POST[answer]','minussh200','%s','%s')", $row['id'],$grade,$grade_num);
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
