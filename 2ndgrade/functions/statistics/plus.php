...
<?php 
		...
		$username = $_SESSION['username'];
			...
			while($row = mysql_fetch_array($result))
			{
				if ($row['yes_count'] == 1 && $row['subject'] == pluss100)
				{
					$counter_yes1 = $counter_yes1+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == pluss100)
				{
					$counter_no1 = $counter_no1+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == plus200)
				{
					$counter_yes2 = $counter_yes2+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == plus200)
				{
					$counter_no2 = $counter_no2+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == plus1000)
				{
					$counter_yes3 = $counter_yes3+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == plus1000)
				{
					$counter_no3 = $counter_no3+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == plussh200)
				{
					$counter_yes4 = $counter_yes4+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == plussh200)
				{
					$counter_no4 = $counter_no4+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == plussh1000)
				{
					$counter_yes5 = $counter_yes5+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == plussh1000)
				{
					$counter_no5 = $counter_no5+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == vertical_plus1)
				{
					$counter_yes6 = $counter_yes6+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == vertical_plus1)
				{
					$counter_no6 = $counter_no6+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == vertical_plus2)
				{
					$counter_yes7 = $counter_yes7+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == vertical_plus2)
				{
					$counter_no7 = $counter_no7+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == vertical_plus3)
				{
					$counter_yes8 = $counter_yes8+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == vertical_plus3)
				{
            ...
            <tr><td><p>חיבור עד 100</p></td><td><P><? if ($total1!=0){ echo intval($counter_yes1/$total1 * 100), "% אחוזי הצלחה"; } 
			else echo "עדיין אין נתונים" ?></P></td></tr>
            <tr><td><p>חיבור עד 200</p></td><td><P><? if ($total2!=0){ echo intval($counter_yes2/$total2 * 100), "% אחוזי הצלחה"; }
			else echo "עדיין אין נתונים" ?></P></td></tr>
            <tr><td><p>חיבור בעשרות עד 1000</p></td><td><P><?  if ($total3!=0){ echo intval($counter_yes3/$total3 * 100), "% אחוזי הצלחה"; }
			else echo "עדיין אין נתונים"  ?></P></td></tr>
            <tr><td><p>חיבור בשרשרת עד 200</p></td><td><P><? if ($total4!=0){ echo intval($counter_yes4/$total4 * 100), "% אחוזי הצלחה";  }
			else echo "עדיין אין נתונים" ?></P></td></tr>
            <tr><td><p>חיבור בשרשרת עד 1000</p></td><td><P><? if ($total5!=0){ echo intval($counter_yes5/$total5 * 100), "% אחוזי הצלחה"; }
			else echo "עדיין אין נתונים" ?></P></td></tr>
            <tr><td><p>חיבור במאונך - רמה קלה</p></td><td><P><? if ($total6!=0){ echo intval($counter_yes6/$total6 * 100), "% אחוזי הצלחה"; }
			else echo "עדיין אין נתונים" ?></P></td></tr> 
            <tr><td><p>חיבור במאונך - רמה בינונית</p></td><td><P><? if ($total7!=0){ echo intval($counter_yes7/$total7 * 100), "% אחוזי הצלחה"; }
			else echo "עדיין אין נתונים" ?></P></td></tr>
