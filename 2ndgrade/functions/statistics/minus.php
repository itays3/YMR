...
<?php 
		...
		$username = $_SESSION['username'];
			...
			while($row = mysql_fetch_array($result))
			{
				if ($row['yes_count'] == 1 && $row['subject'] == minuss100)
				{
					$counter_yes1 = $counter_yes1+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == minuss100)
				{
					$counter_no1 = $counter_no1+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == minus200)
				{
					$counter_yes2 = $counter_yes2+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == minus200)
				{
					$counter_no2 = $counter_no2+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == minus1000)
				{
					$counter_yes3 = $counter_yes3+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == minus1000)
				{
					$counter_no3 = $counter_no3+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == minussh200)
				{
					$counter_yes4 = $counter_yes4+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == minussh200)
				{
					$counter_no4 = $counter_no4+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == minussh1000)
				{
					$counter_yes5 = $counter_yes5+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == minussh1000)
				{
					$counter_no5 = $counter_no5+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == vertical_minus1)
				{
					$counter_yes6 = $counter_yes6+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == vertical_minus1)
				{
					$counter_no6 = $counter_no6+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == vertical_minus2)
				{
					$counter_yes7 = $counter_yes7+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == vertical_minus2)
				{
					$counter_no7 = $counter_no7+1;
				}
				if ($row['yes_count'] == 1 && $row['subject'] == vertical_minus3)
				{
					$counter_yes8 = $counter_yes8+1;
				}
				if ($row['no_count'] == 1 && $row['subject'] == vertical_minus3)
				{
            ...
            <tr><td><p>חיסור במאונך - רמה קלה</p></td><td><P><? if ($total6!=0){ echo intval($counter_yes6/$total6 * 100), "% אחוזי הצלחה"; }
			else echo "עדיין אין נתונים" ?></P></td></tr>
            <tr><td><p>חיסור במאונך - רמה בינונית</p></td><td><P><? if ($total7!=0){ echo intval($counter_yes7/$total7 * 100), "% אחוזי הצלחה"; }
			else echo "עדיין אין נתונים" ?></P></td></tr>
            <tr><td><p>חיסור במאונך - רמה קשה</p></td><td><P><? if ($total8!=0){ echo intval($counter_yes8/$total8 * 100), "% אחוזי הצלחה"; }
			else echo "עדיין אין נתונים" ?></P></td></tr>                                    
            </table>
