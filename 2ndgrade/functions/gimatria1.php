...
{
if ($_POST['last_num']==$_POST['answer']){
$sql= sprintf("INSERT INTO statistics  (s_id,yes_count, yes_answer, subject, grade, grade_num)
VALUES
('%s','1','$_POST[last_letter]$_POST[equal]$_POST[last_num]','gimatria1','%s','%s')", $row['id'],$grade,$grade_num);
...
VALUES
('%s', '1', '$_POST[last_letter]$_POST[equal]$_POST[last_num]',
'$_POST[last_letter]$_POST[equal]$_POST[answer]','gimatria1','%s','%s')", $row['id'],$grade,$grade_num);
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
...
mysql_close($con);?>
    ...
    <h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">גימטריה - אותיות למספרים</h1>
	<p dir="rtl"
...
<form method="post" action="gimatria1.php" dir="rtl">    
    ...
    <!-- this part shows the last exercise and the answer-->
			...
			<?php if(!empty($_POST['last_letter'])) {?>
