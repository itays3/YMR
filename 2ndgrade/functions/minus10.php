...
VALUES
('%s','1','$_POST[last_a]$_POST[minus]$_POST[last_b]$_POST[equal]$_POST[answer]','minuss100','%s','%s')", $row['id'],$grade,$grade_num);
...
'$_POST[last_a]$_POST[minus]$_POST[last_b]$_POST[equal]$_POST[answer]','minuss100','%s','%s')", $row['id'],$grade,$grade_num);
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
