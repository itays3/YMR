...
<body>
	...
	<?php 
	  ...
	  while ($x+$y >1000 )
	  {
		...
		$the_answer = $x+$y;?>
<form method="post" action="vertical_plus2.php" dir="ltr">    
...
VALUES
('%s','1','$_POST[last_a]$_POST[plus]$_POST[last_b]$_POST[equal]$_POST[the_answer]','vertical_plus2','%s','%s')", $row['id'],$grade,$grade_num);
...
'$_POST[last_a]$_POST[plus]$_POST[answer]$_POST[equal]$_POST[oldanswer]','vertical_plus2','%s','%s')", $row['id'],$grade,$grade_num);
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
