...
<!-------------------------------------------------------->
  ...
  <div class="content">
<table cellpadding="5" cellspacing="5" dir="rtl" align="right">
<form action="login.php" method='post' dir="rtl">
<tr><td>	בית ספר: <select name="school" size="1" dir="rtl" lang="he"><option>אורט רמות</option><option>מקיף ג'</option></select></td></tr>
<tr><td>	שם משתמש:<input type="text" name='username' /></td>
<tr><td>	סיסמא:<input type="password" name='password' /></td></tr>
...
<table align="center"><tr><td>hello</td></tr></table>
<!-- end .sidebar2 --></div>
