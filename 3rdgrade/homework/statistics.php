...
<link rel="stylesheet" type="text/css" href="functions/statistics/inc.css" />
...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; סטטיסטיקה</li>
    	<li><a href="functions/statistics1.php" target="Mainframe" >&nbsp;סטטיסטיקה אישית</a></li>
    	<li><a href="functions/statistics2.php" target="Mainframe" >&nbsp;סטטיסטיקה כיתתית</a></li>
	    <li><a href="functions/statistics3.php" target="Mainframe" >&nbsp;סטטיסטיקה בית ספרית</a></li>
	    <li><a href="functions/statistics4.php" target="Mainframe" >&nbsp;סטטיסטיקה ארצית</a></li>
    </ul>
