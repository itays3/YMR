...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חיסור עד 200</h1>
	<p dir="rtl"
	...
	<?php 
	  ...
	  $the_answer = $x-$y;
?>
<form method="post" action="minus_b3.php" dir="ltr">    
...
VALUES
('%s','1','$_POST[last_x]$_POST[minus]$_POST[last_y]$_POST[equal]$_POST[answer]','minus_b3','%s','%s')", $row['id'],$grade,$grade_num);
...
$query = "SELECT s_id, SUM(yes_count) FROM statistics WHERE s_id='$s_id' && subject='minus_b3'  GROUP BY s_id"; 
...
$query=sprintf("UPDATE connect SET minus_b3='%s' WHERE s_id='%s' ;",
