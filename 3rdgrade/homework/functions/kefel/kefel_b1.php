...
<body>
    ...
    <h1 dir="rtl" style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">פתור בעזרת חוק הפילוג</h1>
<?php 
	  session_start();
	  $x = rand(100,1000);
      $y = rand(2,10);
