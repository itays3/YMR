...
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">חילוק ארוך</h1>
	<p dir="rtl"
	...
	<?php 
	  ...
	  $the_answer = $x/$y;
?>
<form method="post" action="hiluk_L1.php" dir="ltr">    
<table align="center" dir="ltr">
    
        	
    	<tr><td align="center" style="border-right: thin solid black; border-top: thin solid black;"><?php print $x; ?> </td>
    	...
    	<input name="the_answer" type="hidden" value="<?=$the_answer?>"/>
			<td style="border-top: thick solid black;"><input name="answer" type="text" size="5"/></td>
