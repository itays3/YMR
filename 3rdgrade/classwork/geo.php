...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; גאומטריה</li>
		<li><a href="functions/maingeo_a.php" target="Mainframe">&nbsp;זוויות</a></li>
    	<li><a href="functions/maingeo_b.php" target="Mainframe">&nbsp;מרובעים</a></li>
    	<li><a href="functions/maingeo_c.php" target="Mainframe">&nbsp;משולשים</a></li>
	    <li><a href="functions/maingeo_d.php" target="Mainframe">&nbsp;עיגולים</a></li>
