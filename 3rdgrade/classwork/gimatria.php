...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    <li>&nbsp; גימטריה</li>
    	<li><a href="functions/gimatria1.php" target="Mainframe">&nbsp;אותיות למספרים</a></li>
    	<li><a href="functions/gimatria2.php" target="Mainframe">&nbsp;מספרים לאותיות</a></li>
	    <li><a href="functions/gimatria3.php" target="Mainframe">&nbsp;סדרות של אותיות</a></li>
	    <li><a href="functions/gimatria4.php" target="Mainframe">&nbsp;ערכים של מילים</a></li>
    </ul>
