...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; חיסור</li>
    	<li><a href="functions/shapes1.php" target="Mainframe" >&nbsp;צורות 1</a></li>
    	<li><a href="functions/shapes2.php" target="Mainframe">&nbsp;צורות 2</a></li>
	    <li><a href="functions/shapes3.php" target="Mainframe">&nbsp;צורות 3</a></li>
