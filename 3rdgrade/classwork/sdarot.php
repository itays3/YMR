...
<div class="sidebar1">
    ...
    <table><tr><td><?
       ...
       <ul class="nav" dir="rtl">      
	    ...
	    <li>&nbsp; סדרות</li>
    	<li><a href="functions/sdarot1.php" target="Mainframe">&nbsp;רמה קלה</a></li>
    	<li><a href="functions/sdarot2.php" target="Mainframe">&nbsp;רמה בינונית</a></li>
	    <li><a href="functions/sdarot3.php" target="Mainframe">&nbsp;רמה קשה</a></li>
