...
<div class="menu" dir="ltr">
    <ul id="menu" dir="ltr">
        <li><a href="3ndgrade/statistics.php">סטטיסטיקה</a></li>
        ...
        <li value="1"><a href="2ndgrade/homework.php">תרגילי בית</a></li>
    </ul>
    <div id="slide"></div>
</div>
...
<div class="inc">
<h1 dir="rtl" 
    style="font-family:Cursive;font-size:36px;color:#3300cc;font-style:italic;font-weight:normal;text-shadow:4px 4px 8px black;">הדף בשלבי הקמה</h1>
    </div>
